...
Add the line to your `~/.bashrc`, `~/.zshrc`, or `~/.config/fish/completions/` for persistent completion. Completes profile names after `-p`, profile subcommands, and top-level commands.
